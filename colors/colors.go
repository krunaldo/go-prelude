...
func Black(args ...interface{}) string {
    return treatAll(FgBlack, args...)
}

func Red(args ...interface{}) string {
    return treatAll(FgRed, args...)
}

func Green(args ...interface{}) string {
    return treatAll(FgGreen, args...)
}

func Yellow(args ...interface{}) string {
    return treatAll(FgYellow, args...)
}

func Blue(args ...interface{}) string {
    return treatAll(FgBlue, args...)
}

func Magenta(args ...interface{}) string {
    return treatAll(FgMagenta, args...)
}

func Cyan(args ...interface{}) string {
    return treatAll(FgCyan, args...)
}

func White(args ...interface{}) string {
    return treatAll(FgWhite, args...)
}
